...
1. `python3 scripts/diagnose_helper.py run --engine manual --run-id force-refresh-pilot20-20260207`
2. Fill session mechanism outputs using the diagnose-session skill.
3. Apply results:
   `python3 scripts/diagnose_helper.py apply --run-id force-refresh-pilot20-20260207 --result-file <result.json>`
