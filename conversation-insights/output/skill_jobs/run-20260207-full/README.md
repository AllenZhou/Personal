...
1. `python3 scripts/pipeline.py diagnose run --engine manual --run-id run-20260207-full`
2. Fill session mechanism outputs using the diagnose-session skill.
3. Apply results:
   `python3 scripts/pipeline.py diagnose apply --run-id run-20260207-full --result-file <result.json>`
